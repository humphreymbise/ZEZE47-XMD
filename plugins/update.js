...
cmd({
  ...
  alias: ["upgrade", "sync"],
  react: '🧠',
  desc: "Update ZEZE47-XMD bot from GitHub.",
  category: "system",
  filename: __filename
  ...
  try {
    await reply("🔎 Checking for ZEZE47-XMD updates...");

    const repo = "humphreymbise/ZEZE47-XMD ";
    ...
    if (latestHash === currentHash) {
      return reply("✅ You are already using the latest version of ZEZE47-XMD!");
    }
    ...
    const sourcePath = path.join(extractPath, "ZEZE47-XMD-main");
